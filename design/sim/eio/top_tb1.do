...
# Package Files
vlog  -sv -hazards +define+SIM_DEBUG                     +incdir+../../src/includes    ../../src/pkg/logic_params_pkg.sv
vlog  -sv -hazards +define+SIM_DEBUG                     +incdir+../../src/includes    ../../src/pkg/functions_pkg.sv
vlog  -sv -hazards +define+SIM_DEBUG                     +incdir+../../src/includes    ../../src/pkg/cpu_params_pkg.sv
vlog  -sv -hazards +define+SIM_DEBUG                     +incdir+../../src/includes    ../../src/pkg/cpu_structs_pkg.sv
vlog  -sv -hazards +define+SIM_DEBUG                                                   ../../src/emu/RV_EMU_params_pkg.sv
...
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/fetch.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/fpr.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/gpr.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/idr_fu.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/im_fu.sv
...
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/spfp_fu.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/vedic_mult16x16.v
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/vedic_mult32x32.v
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/cpu_src/wb.sv
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           ../../src/emu/RV_EMU_core.svp

# Simulation test file in same folder as .mpf
vlog  -sv -hazards +define+SIM_DEBUG  +cover                                           external_register.sv
...
vlog  -sv -hazards +define+SIM_DEBUG                                                   ../../src/sva/wb_asserts.sv
vlog  -sv -hazards +define+SIM_DEBUG                                                   ../../src/sva/pipe_asserts.sv
vlog  -sv -hazards +define+SIM_DEBUG                                                   ../../src/sva/RV_EMU_asserts.svp
