...
# Package Folder Files +ext_M+ext_U+SIM_DEBUG
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/pkg/logic_params_pkg.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/pkg/functions_pkg.sv
...
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_av_rdata.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_ff.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_fu.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_lo_cnt.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_nxt_reg.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/csr_regs.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/decode.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/decode_core.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/execute.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/fetch.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/fpr.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/gpr.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/idr_fu.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/im_fu.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/irq.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/ls_fu.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/mem.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/mode_irq.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/pipe.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/RisKy1_core.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/sdiv_N_by_N.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/spfp_fu.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/vedic_mult16x16.v
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/vedic_mult32x32.v
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/cpu_src/wb.sv
...
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG+SIM_DEBUG                                               ../../src/peripherals/peripheral_intf.sv
...
#vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG+TEST_FILE=\"instr_tests/modeMU_mcause.rom\"            ../../src/models/sys_mem_model.sv
#vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG+TEST_FILE=\"instr_tests/replay_IIL_0_49.rom\"          ../../src/models/sys_mem_model.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG+TEST_FILE=\"instr_tests/csr_mscratch_all_1.rom\"        ../../src/models/sys_mem_model.sv


# Top Level Simulation File - add +BIND_ASSERTS if doing assertion testing
#vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG+BIND_ASSERTS+MAX_CYC=30                                 top_tb1.sv
...
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/questa_formal/property_checks/RV32imc_model.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG        +incdir+../../src/questa_formal/property_checks  ../../src/questa_formal/property_checks/RV32imc_asserts.sv

# Assertion/Property Files
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/sva/csr_asserts.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/sva/gpr_asserts.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/sva/mem_asserts.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/sva/wb_asserts.sv
vlog  -sv -hazards +define+ext_M+ext_C+ext_U+SIM_DEBUG                                                         ../../src/sva/pipe_asserts.sv
