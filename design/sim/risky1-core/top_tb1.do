...
# Package Folder Files +ext_M+ext_S+ext_U+ext_N+SIM_DEBUG
...
vlog  -sv -hazards +define+ext_M+ext_S+ext_U+ext_N+SIM_DEBUG                                                         ../../src/questa_formal/property_checks/RV_EMU_params_pkg.sv
vlog  -sv -hazards +define+ext_M+ext_S+ext_U+ext_N+SIM_DEBUG                                                         ../../src/questa_formal/property_checks/RV_EMU_core.svp
vlog  -sv -hazards +define+ext_M+ext_S+ext_U+ext_N+SIM_DEBUG         +incdir+../../src/questa_formal/property_checks ../../src/questa_formal/property_checks/RV_EMU_asserts.svp
